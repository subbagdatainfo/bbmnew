        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-sm-12 text-center">
                    ...
                    <form name="daftar" id="daftarform" action ="<?=site_url('C_Peserta/view_daftar'); ?>" method="post">
                        <div class="row">
                            <div class ="row-lg-12">
                                ...
                                <div class ="form-group">
                                    <input type ="text" class ="form-control" placeholder="Email" id="email" name="email" required data-validation-required-message="silakan masukan password Anda">
                                    <p class ="help-block text-danger"></p>
                                </div>
                                <div class ="form-group">
                                    <input type ="text" class ="form-control" placeholder="Nomor Telepon" id="no_telpon" name="no_telpon" required data-validation-required-message="silakan masukan password Anda">
                                    <p class ="help-block text-danger"></p>
                                </div>
                            </div>    
                        </div>
